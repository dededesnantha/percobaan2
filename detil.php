...
$sql1="SELECT judul from t_judul where (id_judul = '$id_kat')";
...
$sql2 ="select A.id_judul, a.judul, a.status as xSts, count(b.id_buku) as xjml 
		from t_judul A left outer join t_buku b
		on a.id_judul = b.id_judul
...
if (mysqli_num_rows($hasil2) > 0) {
	...
	while($data = mysqli_fetch_array($hasil2)) { //array -> bisa menggunakan nama field/atribut bisa juga menggunakan indeks
		...
		echo "<tr>
				...
				<td class=\"center\">
					<a href=\"detil.php?id=$data[id_judul]\"> $data[xjml]  </a>
				</td>
			  </tr>";
		$counter++;//increment
	}
