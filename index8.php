...
//query SQL Join t_judul, t_kategori 
// untuk menampilkan tabel judul
$sql1 = "select 
		t_judul.id_judul as id_judul,
		t_judul.judul as judul,
		t_kategori.kategori as kategori,
		t_judul.status as status
		from t_judul
...
if (mysqli_num_rows($hasil) > 0) {
	...
	echo "<h1>DAFTAR TABEL JUDUL</h1>"; //caption
	...
	while($data = mysqli_fetch_array($hasil)) { //array -> bisa menggunakan nama field/atribut bisa juga menggunakan indeks
		...
		echo "<tr>
				...
				<td class=\"center\">$data[kategori]</td>
			  </tr>";
		$counter++;//increment
	}
